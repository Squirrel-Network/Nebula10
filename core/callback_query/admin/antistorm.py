...
@callback_query_regex(r"^antistorm\|set\|(users|seconds)\|minus$")
...
@on_update()
@check_role(Role.OWNER, Role.CREATOR, Role.ADMINISTRATOR)
@callback_query_regex(r"^antistorm\|set\|(users|seconds)\|plus$")
...
@on_update()
@check_role(Role.OWNER, Role.CREATOR, Role.ADMINISTRATOR)
@callback_query_regex(r"^antistorm\|success$")
